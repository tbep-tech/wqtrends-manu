...
p1 <- show_metseason(mod, doystr = 41, doyend = 213, yrstr = 1991, yrend = 2000, ylab = ylab, nsim = nsims) +
  coord_cartesian(ylim = ylim) + 
  labs(
    subtitle = seas[[1]],
    title = NULL
  )
p2 <- show_metseason(mod, doystr = 41, doyend = 213, yrstr = 2000, yrend = 2010, ylab = NULL, nsim = nsims) +
  coord_cartesian(ylim = ylim) + 
  labs(
    subtitle = seas[[2]], 
    title = NULL
  )
p3 <- show_metseason(mod, doystr = 41, doyend = 213, yrstr = 2010, yrend = 2019, ylab = NULL, nsim = nsims) +
  coord_cartesian(ylim = ylim) +  
  labs(
    subtitle = seas[[3]], 
    title = NULL
  )
p4 <- show_metseason(mod, doystr = 213, doyend = 338, yrstr = 1991, yrend = 2000, ylab = ylab, nsim = nsims) +
  coord_cartesian(ylim = ylim) + 
  labs(
    subtitle = seas[[4]], 
    title = NULL
  )
p5 <- show_metseason(mod, doystr = 213, doyend = 338, yrstr = 2000, yrend = 2010, ylab = NULL, nsim = nsims) +
  coord_cartesian(ylim = ylim) + 
  labs(
    subtitle = seas[[5]], 
    title = NULL
  )
p6 <- show_metseason(mod, doystr = 213, doyend = 338, yrstr = 2010, yrend = 2019, ylab = NULL, nsim = nsims) +
  coord_cartesian(ylim = ylim) + 
  labs(
    subtitle = seas[[6]],
    title = NULL
...
p1 <- show_cmpplo('data/modslog_chl36.RData', doystr = 41, doyend = 213, yrstr = 1991, yrend = 2000, 
                  ttl =  '(a) Station 36, Jan-Jul chl. averages', ymax = NULL, nsim = nsims)
p2 <- show_cmpplo('data/modslog_chl36.RData', doystr = 213, doyend = 338, yrstr = 2000, yrend = 2010, 
                  ttl =  '(b) Station 36, Jul-Dec chl. averages', ymax = NULL, ylab = NULL, nsim = nsims)
