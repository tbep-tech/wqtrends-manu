...
```{r, results = 'hide', message = F}
show_cmpplo <- function(datin, doystr, doyend, yrstr, yrend, ttl, ymax = NULL, 
...
load(file = 'data/modslog_chl32.RData')
datin <- modslog_chl32

p1 <- show_cmpplo(datin, doystr = 41, doyend = 213, yrstr = 1991, yrend = 2000, 
                  ttl =  '(a) Station 36, Jan-Jun chl. averages', ymax = NULL, nsim = nsims)
p2 <- show_cmpplo(datin, doystr = 213, doyend = 338, yrstr = 2000, yrend = 2010, 
