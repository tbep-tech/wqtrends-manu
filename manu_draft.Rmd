...
Table \@ref(tab:modprftab), Table \@ref(tab:seastrndtab)
...
# save as png
png('figs/sitemap.png', height = 1800, width = 1400, family = 'serif', res = 300)
print(p)
dev.off()
```
