...
chg2 <- anlz_perchg(mods = toplo, baseyr = 2001, testy = 2010)
chg3 <- anlz_perchg(mods = toplo, baseyr = 2011, testy = 2019)
...
p2 <- show_perchg(mods = toplo, baseyr = 2000, testyr = 2010, ylab = NULL) +
  labs(
    subtitle = paste0('(a) 1991: ', chg[[2, 2]],' ug/L, 2000: ', chg[[2, 3]], 'ug/L\nChange: ', chg[[2, 4]], '%, ', chg[[2, 5]]), 
    title = NULL
  )
p3 <- show_perchg(mods = toplo, baseyr = 2010, testyr = 2019, ylab = NULL) +
  labs(
    subtitle = paste0('(a) 1991: ', chg[[3, 2]],' ug/L, 2000: ', chg[[3, 3]], 'ug/L\nChange: ', chg[[3, 4]], '%, ', chg[[3, 5]]), 
    title = NULL
  )
