...
The next three spline formulations differ in how spline terms compose a model to smooth the raw data.  For convenience, a linear trend in `cont_year` can be specified explicitly as a separate component.  This would be expressed as:
